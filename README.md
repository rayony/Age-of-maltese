...
Cute three-minute RTS. Command the original **Maltese** pack (white) against **Retriever** (golden). Gather cake, train fighters, roll a red convertible, knock the other dog house to zero with pink hearts.
...
- After **3:00**, **Fever**: attack ×2, both houses lose a fixed **20** HP every 15 seconds (double-click the clock to skip to the last 3 seconds)
...
- Wheel or pinch to zoom; **1x / 2x / 4x** speed units and builds (countdown stays real-time)
